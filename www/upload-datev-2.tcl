...
foreach csv_line_fields $values_list_of_lists {
    ...
    switch $absence_type {
	    ...
	    default { 
            set absence_type_id ""
            ns_write "Ignoring absence of type $absence_type for $employee_name with start_date $absence_start<br \>"            
            continue
        }
    }
...
set deleted_absence_ids [db_list deleted_absences "select absence_id from im_user_absences, acs_objects where absence_id = object_id and acs_objects.last_modified < now() - interval '10 minutes' and absence_type_id in (5001) and absence_status_id = :absence_status_id and to_char(start_date,'YYYY') = :year"]
